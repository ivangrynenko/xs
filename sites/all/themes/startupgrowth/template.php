...
function startupgrowth_preprocess_html(&$variables) {
	...
	if ($color_scheme != 'default') {
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/style-' .$color_scheme. '.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-1'  &&
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/merriweather-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-2'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/sourcesanspro-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-3'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/ubuntu-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-4'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/ptsans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-5'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/roboto-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-6'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/opensans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-7'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/lato-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-8'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/roboto-condensed-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-9'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/exo-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-10'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/roboto-slab-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-11'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/raleway-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-12'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/josefin-sans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-14'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/playfair-display-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-15'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/philosopher-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-16'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/cinzel-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-17'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/oswald-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-18'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/playfairdisplaysc-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-19'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/cabin-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-20'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/notosans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-22'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/droidserif-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-23'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/ptserif-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-24'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/vollkorn-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-25'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/alegreya-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}	
	...
	if (theme_get_setting('sitename_font_family')=='sff-26'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/notoserif-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-27'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/crimsontext-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-28'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/gentiumbookbasic-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-29'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/volkhov-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-31'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/fonts/alegreyasc-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	 ...
	 */
	drupal_add_css(drupal_get_path('theme', 'startupgrowth') . '/local.css', array('group' => CSS_THEME, 'type' => 'file'));
