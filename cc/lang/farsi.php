...
$_LANG['cartdomainsconfigdesc'] = "در زیر شما میتوانید نامهای دامنه را در سبد خرید خود  قرار دهید،اطلاعات لازم و نام های سرور را برای آن مشخص کنید";
...
$_LANG['cartproductdesc'] = "این سرویس/کالایی که انتخاب کرده اید دارای امکانات ساختاری زیر است";
$_LANG['cartproductdomain'] = "دامنه ها";
$_LANG['cartproductdomainchoose'] = "انتخاب دامنه";
$_LANG['cartproductdomaindesc'] = "کالا/سرویسی که انتخاب نموده اید نیاز به نام دامنه دارد پس لطفا نام دامنه انتخابی خود را در زیر وارد کنید";
$_LANG['cartproductdomainuseincart'] = "از دامنهی که همینک در سبد خرید است استفاده شود";
...
$_LANG['clientareadomainnone'] = " دامنه هایی با ما ثبت نشده است";
...
$_LANG['clientareaheader'] = "به ناحیه کاربری خود خوش آمدید.ناحیه کاربری به شما این امکان را میدهد که مشخصات خود را مشاهده و بروز نمایید، جزئیات مربوط به بسته هاستینگ و دامنهی را که با ما دارید مشاهده کنید و درخواست پشتیبانی و سفارش جدیدتان را ارائه نمایید.";
...
$_LANG['domainerrortoolong'] = "دامنهی که وارد کرده اید طولانی میباشد.حداکثر طول دامنه 67 کاراکتر میباشد.";
...
$_LANG['domainrenewdesc'] = "با افزایش سال به  دامنهتان آنرا امن تر کنید.از زیر  مشخص کنید کنید چند سال مایلید آنرا تمدید  نمایید و سپس سفارش تمدید را کلیک کنید.";
...
$_LANG['domainsautorenewdisabledwarning'] = "هشدار! تمدید خودکار دامنه غیر فعال است.<br />هنگامی که تاریخ انقضای این دامنه فرا برسد این دامنه غیر فعال می شود و شما باید آن را به صورت دستی شارژ کنید.";
...
$_LANG['orderconfigpackage'] = "انتخابهای قابل پبکربندی";
...
$_LANG['orderdomainoption3'] = "میخواهم دامنهم را  منتقل کنم به";
...
$_LANG['ordererrordomaininvalid'] = "دامنهی که وارد کردید مجاز نمیباشد";
$_LANG['ordererrordomainnotld'] = "شما باید دامنه  TLD  وارد کنید";
$_LANG['ordererrordomainnotregistered'] = "شما نمیتوانید دامنهی را که ثبت نشده است منتقل کنید";
$_LANG['ordererrordomainregistered'] = "دامنهی که شما وارد کردید قبلا ثبت شده است";
...
$_LANG['ordererrorsubdomaintaken'] = "زیردامنهی که وارد کردید قبلا گرفته شده است.لطفا دوباره سعی کنید.";
...
$_LANG['ordersubdomaininuse'] = "زیر دامنهی که وارد کردید استفاده شده است";
...
$_LANG['viewcart'] = "مشاهده سبد خرید";
...
$_LANG['vpsnetcpugraphs'] = "نمدار های CPU";
...
$_LANG['cartenterdomain'] = "لطفا دامنهی را که مایل به استفاده هستید در ادامه وارد نمایید.";
...
$_LANG['carttryanotherdomain'] = "دامنه دیگری را امتحا کنید";
...
$_LANG['ordersummarybegin'] = "سبد خرید خالی است.<br/>لطفا محصولی را برای شروع انتخاب کنید...";
$_LANG['ajaxcartconfigreqnotice'] = "شما در حال ثبت نام هستید ، ولی قبل از آن باید دامنهی را انتخاب کنید تا بتوانید محصول انتخابی را به سبد خود اضافه کنید...";

# Version 5.0.0

$_LANG['cancelrequestdomain'] = "لغو تمدید دامنه؟";
$_LANG['cancelrequestdomaindesc'] = "شما همچنین یک سرویس ثبت دامنه همراه این محصول دارید.<br />این دامنه  در %s با قیمت %s برای %s سال باید تمدید شود.<br /><br />اگر میخواهید دامنه را هم لغو کنید و اجازه دهید که در پایان دوره ثبت منقضی شود کافیست تیک زیر را علامت بزنید.";
$_LANG['cancelrequestdomainconfirm'] = "تایید میکنم که نمیخواهم این دامنه را تمدید کنم";
...
$_LANG['domainautorenewinfo'] = "تمدید خودکار در حفظ دامنه شما مفید است. وقتی که فعال باشد ما مدتی قبل از انقضای دامنه صورتحسابی برای تمدید آن ارسال میکنیم و پس از پرداخت دامنه شما تمدید میشود.";
...
$_LANG['captchaverify'] = "لطفا کارکترهایی که در عکس زیر مشاهده میکنید وارد کنید . این مورد برای جلوگیری از ارسال های خودکار به کار میرود.";
...
$_LANG['backtodomainslist'] = "&laquo; برگشت به لیست دامنه ها";
...
$_LANG['invoicesintro'] = "شما میتوانید سابقه تمام صورتحسابهایتان را از اینجا مشاهده کنید.";
$_LANG['quotesintro'] = "اینجا تمام مظنه هایی که برای شما ارسال شده است را مشاهده میکنید.";
$_LANG['emailstagline'] = "یک نسخه از آخرین ایمیلهایی که به شما ارسال کرده ایم را اینجا مشاهده میکنید ...";
...
$_LANG['masspayintro'] = "تمام صورت حساب های خود را یک جا میتوانید پرداخت کنید.درگاه پرداخت را انتخاب کنید";
...
$_LANG['domaincheckerbulkinvaliddomain'] = "یک یا چند مورد از دامنههای وارد شده معتبر نمیباشند و از نتایج حذف شدند.";
...
$_LANG['licensingreissued'] = "دامنه ، IP و دایرکتوری معتبر دفعه بعد که لایسنس استفاده میشود تشخیص داده و ذخیره میشود.";
