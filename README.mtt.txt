StartupGrowth 2.2.0 README
======================

Thank you for downloading StartupGrowth - Standalone distribution. 
...
----------
Check: 
http://wiki.morethanthemes.com/index.php?title=startupgrowth
...
and read Drupal's INSTALL.txt. The file is located into the [site] folder.
   ...
   1. Unzip the StartupGrowth Drupal theme package.
