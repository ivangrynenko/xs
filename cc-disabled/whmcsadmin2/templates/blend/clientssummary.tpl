...
<ul>
<li><a id="summary-reset-password" href="clientssummary.php?userid={$clientsdetails.userid}&resetpw=true&token={$csrfToken}"><img src="images/icons/resetpw.png" border="0" align="absmiddle" /> {$_ADMINLANG.clients.resetsendpassword}</a>
<li><a id="summary-cccard-details" href="#" onClick="openCCDetails();return false"><img src="images/icons/offlinecc.png" border="0" align="absmiddle" /> {$_ADMINLANG.clientsummary.ccinfo}</a>
<li><a id="summary-login-as-client" href="../dologin.php?username={$clientsdetails.email|urlencode}"><img src="images/icons/clientlogin.png" border="0" align="absmiddle" /> {$_ADMINLANG.clientsummary.loginasclient}</a>
</ul>
</div>
...
<p align="right"><input type="button" value="{$_ADMINLANG.clientsummary.statusfilter}: {if $statusfilterenabled}{$_ADMINLANG.global.on}{else}{$_ADMINLANG.global.off}{/if}" class="btn-small{if $statusfilterenabled} btn-success{/if}" onclick="toggleStatusFilter()" /></p>
<div id="statusfilter">
    <form>
        <div class="checkall">
            <label><input type="checkbox" id="statusfiltercheckall" onclick="checkAllStatusFilter()"{if !$statusfilterenabled} checked{/if} /> {$_ADMINLANG.global.checkall}</label>
        </div>
...
{/foreach}
        ...
        <div class="applybtn">
            <input type="button" value="{$_ADMINLANG.global.apply}" class="btn-small btn-primary" onclick="applyStatusFilter()" />
        </div>
    </form>
</div>
