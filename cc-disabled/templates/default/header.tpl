...
<div id="whmcsheader">
    <div class="whmcscontainer">
        ...
        <div id="whmcsimglogo">
          <a id="logo-link" rel="home" title="Home" href="http://www.redyhost.com.au/">
            <img alt="{$companyname} Home" src="/cc/RedyHOST-logo-web-whmcs.png" />
          </a>
    </div>
</div>
  ...
  <div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
		...
		<ul class="nav">
			<li><a href="{if $loggedin}clientarea{else}index{/if}.php">Clientarea Home</a></li>
		</ul>
{if $loggedin}
    <ul class="nav">
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">{$LANG.navservices}&nbsp;<b class="caret"></b></a>
          <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li><a href="/hosting">Order a cPanel hosting</a></li>
            <li><a href="/vps">Order managed VPS</a></li>
            <li><a href="/vps/self">Order self-managed VPS</a></li>
            <li><a href="/ssl-security/geotrust">Order a SSL Certificate</a></li>
          </ul>
        </li>
      </ul>
          ...
          {if $condlinks.domainreg || $condlinks.domaintrans}<ul class="nav">
            <li class="dropdown"><a id="Menu-Domains" class="dropdown-toggle" data-toggle="dropdown" href="#">{$LANG.navdomains}&nbsp;<b class="caret"></b></a>
              <ul class="dropdown-menu">
                ...
                {if $condlinks.domainreg}<li><a href="/cc/domainchecker.php?search=bulkregister">Bulk Register Domains</a></li>{/if}
          ...
          <ul class="nav">
            <li class="dropdown"><a id="Menu-Support" class="dropdown-toggle" data-toggle="dropdown" href="#">{$LANG.navsupport}&nbsp;<b class="caret"></b></a>
              <ul class="dropdown-menu">
                ...
                <li><a id="Menu-Support-Monitis" href="monitis_monitors.php">Service Monitors</a></li>
                <li><a id="Menu-Support-Monitis" href="monitis_networkstatus.php">Network Monitors</a></li>
...
{else}
          ...
          <ul class="nav">
            <li><a id="Menu-Contact_Us" href="/contact">{$LANG.contactus}</a></li>
          </ul>
          <ul class="nav">
            <li><a href="/cc/cart.php?a=view">View Cart</a></li>
          </ul>
