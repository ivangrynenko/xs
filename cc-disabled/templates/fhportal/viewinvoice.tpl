...
<body bgcolor="#efefef" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size: 10px;">
...
<hr style="height:1px; color:#999; border: none;"/>
<h6 style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size: 13px;">Bank Details</h6>
Account name: <strong>TRUECMS PTY LTD</strong>
Account number: <strong>338633</strong>, BSB: <strong>033181</strong>, Bank: <strong>Westpac</strong>
